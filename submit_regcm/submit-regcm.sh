...
base=/leonardo_scratch/large/userexternal/clu00000/CORDEX
...
startDate="${2:-1970010100}" #start Date
dep=$3
...
mkdir -p $tdir
 ...
 startTarget=1970010100
  #endTarget=1971020100
  ##endTarget=1972040100
  #endTarget=1976010100
  #endTarget=1981010100
  ##endTarget=1981020100
  ##endTarget=1981030100
  ##endTarget=1982010100
  #endTarget=1986010100
  #endTarget=1991010100
  ##endTarget=1990020100
  #endTarget=1996010100
  ##endTarget=1995020100
  #endTarget=2001010100
  #endTarget=2006010100
  ##endTarget=2006020100
  #endTarget=2011010100
  ##endTarget=2008020100
   endTarget=2016010100
  ##endTarget=2014020100
#
#startTarget=1999010100
#startTarget=2002010100
  #endTarget=2003010100
  #endTarget=2000120100
  #endTarget=2001120100
